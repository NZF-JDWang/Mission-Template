...
// al-Nusra 
	if (_faction==5) then {
	_InfPool=	["cfp_i_alNusra_rifleman_dshkm","cfp_i_alNusra_rifleman_podnos","cfp_i_alNusra_grenadier","cfp_i_alNusra_squad_leader","cfp_i_alNusra_team_leader","cfp_i_alNusra_machinegunner","cfp_i_alNusra_medic","cfp_i_alNusra_sapper","cfp_i_alNusra_machinegunner","cfp_i_alNusra_medic","cfp_i_alNusra_sapper","cfp_i_alNusra_at","cfp_i_alNusra_rifleman","cfp_i_alNusra_at","cfp_i_alNusra_rifleman","cfp_i_alNusra_at","cfp_i_alNusra_rifleman","cfp_i_alNusra_at","cfp_i_alNusra_rifleman","cfp_i_alNusra_rifleman","cfp_i_alNusra_rifleman","cfp_i_alNusra_rifleman","cfp_i_alNusra_sniper","cfp_i_alNusra_sniper","cfp_i_alNusra_sniper","cfp_i_alNusra_sniper","cfp_i_alNusra_sniper"];	
	_ArmPool=	["cfp_i_alNusra_BMP1","cfp_i_alNusra_BMP1P","cfp_i_alNusra_BMP1","cfp_i_alNusra_BMP1P","cfp_i_alNusra_BMP1","cfp_i_alNusra_BMP1P","cfp_i_alNusra_T34","cfp_i_alNusra_T55","cfp_i_alNusra_ZSU","cfp_i_alNusra_Ural_ZU23"];
	_MotPool=	["cfp_i_alNusra_offroad_M2","cfp_i_alNusra_pickup_PK","cfp_i_alNusra_offroad_M2","cfp_i_alNusra_pickup_PK","cfp_i_alNusra_offroad_M2","cfp_i_alNusra_pickup_PK","cfp_i_alNusra_UAZ_SPG9","cfp_i_alNusra_UAZ_MG"];
	_ACHPool=	[];
	_CHPool=	[];
	_uavPool=	[];
	_stPool=	[];
...
// Syrian Arab Army 	
	if (_faction==6) then {
	_InfPool=	["cfp_o_syarmy_machinegunner","cfp_o_syarmy_medic","cfp_o_syarmy_officer","cfp_o_syarmy_sapper","cfp_o_syarmy_sniper","cfp_o_syarmy_grenadier","cfp_o_syarmy_rifleman","cfp_o_syarmy_rifleman","cfp_o_syarmy_rifleman","cfp_o_syarmy_rifleman","cfp_o_syarmy_rifleman","cfp_o_syarmy_at","cfp_o_syarmy_at","cfp_o_syarmy_at"];	
	_ArmPool=	[];
	_MotPool=	[];
	_ACHPool=	[];
	_CHPool=	[];
